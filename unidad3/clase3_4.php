...
<head>
    ...
    <title>Física 3.4 — Fuerza Normal y Fricción</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Fuerza Normal y Fricción</h1>
            <h3>Fuerzas de Contacto</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.4</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Fricción Estática:</strong> Impide el movimiento inicial.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Fricción Cinética:</strong> Se opone al movimiento en curso.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> f_k = μ_k * N
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.4</h2>
            <div class="box">
                <p>Si N=10 N y μ_k=0.2, ¿cuál es la fricción cinética?</p>
            </div>
            <input type="text" id="mission-3-4-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-4-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['2'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! 10 * 0.2 = 2 N.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Multiplica N por mu';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.4 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
