...
<head>
    ...
    <title>Física 3.3 — Diagramas de Cuerpo Libre (DCL)</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Diagramas de Cuerpo Libre (DCL)</h1>
            <h3>Representación de Fuerzas</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.3</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>DCL:</strong> Diagrama que muestra todas las fuerzas que actúan sobre un cuerpo.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Vectores:</strong> Cada fuerza se representa como una flecha.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> ΣFx = 0, ΣFy = 0 (Equilibrio)
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.3</h2>
            <div class="box">
                <p>¿Cómo se llama la fuerza ascendente que ejerce una superficie?</p>
            </div>
            <input type="text" id="mission-3-3-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-3-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['normal', 'fuerza normal'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Actúa perpendicular a la superficie.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Empieza con N';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.3 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
