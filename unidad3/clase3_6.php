...
<head>
    ...
    <title>Física 3.6 — Tensión y Poleas</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Tensión y Poleas</h1>
            <h3>Cuerdas y Máquinas Simples</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.6</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Tensión:</strong> Fuerza transmitida a través de una cuerda ideal (sin masa, inextensible).</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Polea Ideal:</strong> Cambia la dirección de la fuerza sin fricción.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> T1 = T2 (cuerda ideal)
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.6</h2>
            <div class="box">
                <p>Si una polea ideal sostiene dos masas iguales en equilibrio, ¿están acelerando?</p>
            </div>
            <input type="text" id="mission-3-6-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-6-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['no'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! La fuerza neta es 0.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Equilibrio = aceleración 0';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.6 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
