...
<head>
    ...
    <title>Física 3.7 — Movimiento Circular Uniforme</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h3>Dinámica Circular</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.7</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Aceleración Centrípeta:</strong> Apunta hacia el centro de la trayectoria.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Fuerza Centrípeta:</strong> Fuerza neta requerida para mantener la rotación.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> F_c = m*(v² / r)
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.7</h2>
            <div class="box">
                <p>¿Hacia dónde apunta la fuerza centrípeta?</p>
            </div>
            <input type="text" id="mission-3-7-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-7-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['al centro', 'adentro', 'centro'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Mantiene al objeto en el círculo.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Hacia el interior';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.7 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
