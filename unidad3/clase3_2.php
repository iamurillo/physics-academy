...
<head>
    ...
    <title>Física 3.2 — Leyes de Newton</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h3>Fundamentos de Dinámica</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.2</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>1ra Ley:</strong> Inercia.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>2da Ley:</strong> F=ma.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>3ra Ley:</strong> Acción y Reacción.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> ΣF = m*a
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.2</h2>
            <div class="box">
                <p>¿Cuánta fuerza (N) necesitas para acelerar 2 kg a 3 m/s²?</p>
            </div>
            <input type="text" id="mission-3-2-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-2-input').value.trim().toLowerCase();
                    ...
                    if (validAnswers.includes(ans)) {
                        ...
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! 2 * 3 = 6 N.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Multiplica masa por aceleración';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.2 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
