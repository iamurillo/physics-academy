...
<head>
    ...
    <title>Física 3.5 — Plano Inclinado</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h3>Descomposición de Fuerzas</h3>
            <p class="indigo-accent">Unidad 3 — Módulo 3.5</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Eje paralelo:</strong> mg * sin(θ).</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Eje perpendicular:</strong> mg * cos(θ).</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> F_x = mg*sin(θ)
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 3.5</h2>
            <div class="box">
                <p>A mayor ángulo del plano, ¿la fuerza paralela aumenta o disminuye?</p>
            </div>
            <input type="text" id="mission-3-5-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-3-5-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['aumenta'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! El seno del ángulo es mayor.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Piensa en un plano vertical';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 3.5 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
