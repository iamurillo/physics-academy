...
<head>
    ...
    <title>Física 5.2 — Impulso y Momento</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Impulso y Momento</h1>
            <h3>Cambio del Momento Lineal</h3>
            <p class="indigo-accent">Unidad 5 — Módulo 5.2</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Impulso (J):</strong> Fuerza aplicada por un intervalo de tiempo.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Teorema del Impulso:</strong> El impulso es igual al cambio en el momento lineal.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> J = F * Δt = Δp
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 5.2</h2>
            <div class="box">
                <p>Si aplicas 10 N por 3 s, ¿cuál es el impulso?</p>
            </div>
            <input type="text" id="mission-5-2-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-5-2-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['30'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! 10 * 3 = 30 N·s.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Multiplica F por t';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 5.2 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
