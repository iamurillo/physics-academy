...
<head>
    ...
    <title>Física 5.3 — Conservación del Momento</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Conservación del Momento</h1>
            <h3>Sistemas Aislados</h3>
            <p class="indigo-accent">Unidad 5 — Módulo 5.3</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Conservación:</strong> Si no hay fuerzas externas, el momento total del sistema es constante.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Aplicación:</strong> Útil para estudiar choques y explosiones.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> P_inicial = P_final
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 5.3</h2>
            <div class="box">
                <p>Un astronauta en el espacio lanza una herramienta hacia adelante. ¿Hacia dónde se mueve él?</p>
            </div>
            <input type="text" id="mission-5-3-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-5-3-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['atras', 'hacia atras'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Por conservación, las velocidades son opuestas.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Piensa en el retroceso';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 5.3 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
