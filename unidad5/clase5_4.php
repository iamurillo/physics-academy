...
<head>
    ...
    <title>Física 5.4 — Colisiones 1D</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Colisiones 1D</h1>
            <h3>Choques</h3>
            <p class="indigo-accent">Unidad 5 — Módulo 5.4</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Elástico:</strong> Se conserva la energía cinética y el momento.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Inelástico:</strong> Se conserva el momento, se pierde Ec.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Totalmente Inelástico:</strong> Los cuerpos se pegan.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> m1v1 + m2v2 = (m1+m2)vf
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 5.4</h2>
            <div class="box">
                <p>¿En qué tipo de choque los objetos se quedan pegados?</p>
            </div>
            <input type="text" id="mission-5-4-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-5-4-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['inelasticamente perfecto', 'totalmente inelastico', 'perfectamente inelastico', 'inelastico'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Es la definición máxima de choque inelástico.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Tienen la palabra inelástico';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 5.4 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
