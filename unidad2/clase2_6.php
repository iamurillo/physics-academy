...
<head>
    ...
    <title>Física 2.6 — Análisis Gráfico</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h3>Gráficas x-t y v-t</h3>
            <p class="indigo-accent">Unidad 2 — Módulo 2.6</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Pendiente x-t:</strong> Representa la velocidad.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Pendiente v-t:</strong> Representa la aceleración.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> Pendiente = Δy / Δx
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 2.6</h2>
            <div class="box">
                <p>Si la gráfica x-t es una línea recta horizontal, ¿cuál es la velocidad?</p>
            </div>
            <input type="text" id="mission-2-6-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-2-6-input').value.trim().toLowerCase();
                    ...
                    if (validAnswers.includes(ans)) {
                        ...
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! La posición no cambia, el objeto está en reposo.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Si no se mueve, v=0';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 2.6 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
