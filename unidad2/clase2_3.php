...
<head>
    ...
    <title>Física 2.3 — Velocidad Media e Instantánea</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Velocidad Media e Instantánea</h1>
            <h3>Cálculo de velocidades</h3>
            <p class="indigo-accent">Unidad 2 — Módulo 2.3</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Velocidad Media:</strong> Desplazamiento total dividido por el tiempo total.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Velocidad Instantánea:</strong> Velocidad en un instante específico (límite).</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> v_m = Δx / Δt
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 2.3</h2>
            <div class="box">
                <p>¿Cuál es la velocidad media (m/s) de un coche que recorre 100 m en 5 s?</p>
            </div>
            <input type="text" id="mission-2-3-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-2-3-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['20'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! 100 / 5 = 20 m/s.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Usa la fórmula v = d/t';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 2.3 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
