...
<head>
    ...
    <title>Física 2.8 — Movimiento en 2D</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Movimiento en 2D</h1>
            <h3>Tiro Parabólico</h3>
            <p class="indigo-accent">Unidad 2 — Módulo 2.8</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Independencia de Ejes:</strong> El movimiento en X es independiente del movimiento en Y.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Trayectoria Parabólica:</strong> Combinación de MRU (X) y MRUA (Y).</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> x = v0x*t ; y = y0 + v0y*t - 1/2*g*t²
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 2.8</h2>
            <div class="box">
                <p>¿Qué tipo de movimiento tiene el proyectil en el eje X?</p>
            </div>
            <input type="text" id="mission-2-8-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-2-8-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['mru', 'rectilineo uniforme', 'constante'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! La velocidad en X no cambia.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Es un movimiento sin aceleración';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 2.8 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
