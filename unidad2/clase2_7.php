...
<head>
    ...
    <title>Física 2.7 — Caída Libre</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Caída Libre</h1>
            <h3>Aceleración gravitacional</h3>
            <p class="indigo-accent">Unidad 2 — Módulo 2.7</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Gravedad (g):</strong> Aceleración constante hacia abajo (aprox 9.8 m/s²).</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Independencia de la Masa:</strong> Todos los objetos caen con igual aceleración si ignoramos el aire.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> y = y0 + v0*t - 1/2*g*t²
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 2.7</h2>
            <div class="box">
                <p>Si dejas caer una piedra, ¿cuál es su velocidad inicial?</p>
            </div>
            <input type="text" id="mission-2-7-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-2-7-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['0', 'cero'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Parte del reposo.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Se deja caer, no se lanza';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 2.7 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
