...
<head>
    ...
    <title>Física 4.4 — Energía Potencial</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Energía Potencial</h1>
            <h3>Energía de Posición</h3>
            <p class="indigo-accent">Unidad 4 — Módulo 4.4</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Potencial Gravitatoria:</strong> Depende de la altura.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Potencial Elástica:</strong> Almacenada en resortes deformados.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> Ep = mgh ; Epe = 1/2*k*x²
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 4.4</h2>
            <div class="box">
                <p>Si subes un bloque al doble de altura, ¿qué pasa con su Ep gravitatoria?</p>
            </div>
            <input type="text" id="mission-4-4-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-4-4-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['se duplica', 'el doble', 'doble'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Es directamente proporcional a la altura.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. h cambia a 2h';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 4.4 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
