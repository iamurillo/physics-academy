...
<head>
    ...
    <title>Física 4.6 — Potencia</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Potencia</h1>
            <h3>Rapidez con que se realiza trabajo</h3>
            <p class="indigo-accent">Unidad 4 — Módulo 4.6</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Potencia (P):</strong> Trabajo dividido por el tiempo.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Unidades:</strong> Vatios (W) = Joules / segundo.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> P = W / t
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 4.6</h2>
            <div class="box">
                <p>¿Si haces 100 J de trabajo en 2 s, cuál es la potencia (W)?</p>
            </div>
            <input type="text" id="mission-4-6-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-4-6-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['50'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! 100 / 2 = 50 W.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Divide W entre t';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 4.6 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
