...
<head>
    ...
    <title>Física 4.5 — Conservación de la Energía Mecánica</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <p class="indigo-accent">Unidad 4 — Módulo 4.5</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Energía Mecánica (Em):</strong> Suma de cinética y potencial.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Sistema Aislado:</strong> Em inicial = Em final.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> Ec_i + Ep_i = Ec_f + Ep_f
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 4.5</h2>
            <div class="box">
                <p>En la cima de una montaña rusa desde el reposo, ¿qué energía es máxima?</p>
            </div>
            <input type="text" id="mission-4-5-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-4-5-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['potencial', 'ep'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! La altura es máxima, la velocidad es 0.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Relacionada con la altura';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 4.5 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
