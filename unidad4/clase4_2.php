...
<head>
    ...
    <title>Física 4.2 — Trabajo y Energía Cinética</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Trabajo y Energía Cinética</h1>
            <h3>Relación Trabajo-Energía</h3>
            <p class="indigo-accent">Unidad 4 — Módulo 4.2</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Trabajo Neto:</strong> Suma de los trabajos de todas las fuerzas.</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Teorema:</strong> El trabajo neto equivale al cambio en la energía cinética.</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> W_neto = ΔEc
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 4.2</h2>
            <div class="box">
                <p>Si un objeto parte del reposo y gana 50 J de Ec, ¿cuál fue el trabajo neto?</p>
            </div>
            <input type="text" id="mission-4-2-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-4-2-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['50', '50 j'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! El trabajo es el cambio en Ec.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. W = Ec final - Ec inicial';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 4.2 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
