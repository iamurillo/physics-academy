...
<head>
    ...
    <title>Física 4.3 — Fuerzas Conservativas y No Conservativas</title>
...
<div class="reveal">
    <div class="slides">
        ...
        <section class="centered">
            ...
            <h1>Fuerzas Conservativas y No Conservativas</h1>
            <h3>Conservación de la Energía</h3>
            <p class="indigo-accent">Unidad 4 — Módulo 4.3</p>
            <hr>
        ...
        <section>
            ...
            <div class="box">
                <ul class="custom-list">
                    <li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>Conservativas:</strong> El trabajo no depende de la trayectoria (ej: gravedad).</li><li class="fragment"><i class="fas fa-check-circle indigo-accent"></i> <strong>No Conservativas:</strong> Disipan energía (ej: fricción).</li>
                </ul>
            </div>
            <div class="fragment success-box">
                <i class="fas fa-lightbulb green"></i> <strong>Fórmula Principal:</strong> W_nc = ΔEm
            </div>
        </section>

        <section>
            <h2><i class="fas fa-crosshairs highlight"></i> Mini Misión 4.3</h2>
            <div class="box">
                <p>¿La fricción es una fuerza conservativa o no conservativa?</p>
            </div>
            <input type="text" id="mission-4-3-input" class="mission-input" placeholder="Escribe tu respuesta aquí...">
            <button onclick="checkMission()" class="mission-btn">Verificar</button>
            <div id="mission-feedback" class="mission-feedback"></div>
            <script>
                function checkMission() {
                    const ans = document.getElementById('mission-4-3-input').value.trim().toLowerCase();
                    const fb = document.getElementById('mission-feedback');
                    const validAnswers = ['no conservativa'];
                    fb.style.display = 'block';
                    if (validAnswers.includes(ans)) {
                        fb.className = 'mission-feedback success-box';
                        fb.style.border = '1px solid #00e676';
                        fb.innerHTML = '<i class="fas fa-check-circle green"></i> ¡Correcto! Disipa energía en forma de calor.';
                    } else {
                        fb.className = 'mission-feedback warning-box';
                        fb.style.border = '1px solid #ff5252';
                        fb.innerHTML = '<i class="fas fa-times-circle highlight"></i> Incorrecto. Piensa si se pierde energía';
                    }
                }
            </script>
        </section>
        ...
        <section class="homework-slide">
            ...
            <div class="box">
                <p>Resuelve los ejercicios correspondientes al Módulo 4.3 en tu cuaderno y preséntalos al final de la sesión.</p>
            </div>
        </section>
